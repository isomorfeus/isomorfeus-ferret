...
require File.expand_path(File.join(File.dirname(__FILE__), "tc_index_searcher.rb"))
...
class MultiSearcherTest < Test::Unit::TestCase
  ...
  DOCUMENTS2 = [
    ...
    {"date" => "20051016", :field => "word1 the quick fox is brown and hairy and a little red",
